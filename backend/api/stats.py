...
from ..privacy import can_see_names, serialize_games, serialize_player_stats
...
def get_player_games(player_id: int, request: Request, session: Session = Depends(get_session)):
...
def get_player_stats(
    ...
    return serialize_player_stats(stats, show_names=can_see_names(request))
